...
### 소스 코드 해석 순서
![V8 Pipeline](/images/Node.js/v8compiler-pipeline.png)
:::tip
...
- **Node 내부 구조**  
<img src="/images/Node.js/node-structure.jpeg" style="width:50%; text-align:center;">  
...
![/images/javascript-runtime.gif](/images/Node.js/javascript-runtime.gif)  
...
![microtask-queue](/images/Node.js/microtask-queue.gif)
![eventloop-promise](/images/Node.js/eventloop-promise.png)
